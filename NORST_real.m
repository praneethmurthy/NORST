function [BG, FG, L_hat, S_hat, T_hat, t_hat, ...
    P_track_full, T_calc]= ...
    NORST_real(M1, P_init, mu, ev_thresh, alpha, K)
%%%This is the NORST algorithm. This is the main function for the real video Background-
%%%Foreground separation problem. 

%This folder contains the code accompanying paper. Please cite this if
%you use the code
%
